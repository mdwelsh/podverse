  ...
  return (
    <div className="mx-auto mt-8 flex w-11/12 flex-col gap-4 md:w-3/5">
      ...
      <div className="text-muted-foreground mt-4">
        ...
        Podverse does with your content is fully under your control. We will never use your content to train new models
        or generate new material, and you can remove your podcast from Podverse at any time. Our whole mission is to
        make sure you get the most out of your podcast, not to undercut creators.
      </div>
      <div className="text-muted-foreground mt-4">
      ...
      <div className="text-muted-foreground">
        ...
        , an AI hacker and entrepreneur from Seattle. He was formerly a CS professor and engineer at Google and Apple,
        and has been hacking computers since the 1980s. Podverse is the first project from{' '}
